...
class TestExam(unittest.TestCase):
    ...
    def testAddClaim(self):
            request = {
                ...
                "data": {
                    "user": 
                        {
                            "email": "claudia.gamboa@raxacademy.com",
                            "role": "admin"
                        }
                },
                "database": "entities",
            ...
            # Log the user in
            #user = auth.sign_in_with_email_and_password("rfmh24hr@gmail.com", "Honda2003")            
            
            obj = processRequest(request)
            logging.debug( json.dumps(obj,  indent=4, sort_keys=True) )
    
    def testGetClaim(self):
            request = {
                "action": "getClaims",
                "data": {
                    "user": 
    ...
    def testgetUserListForClaim(self):
            request = {
