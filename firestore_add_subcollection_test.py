...
class TestFireStore(unittest.TestCase):
    ...
    def testAddSubCollection(self):
            ...
            subcollection = firestore_connect.processRequest(req)
            logging.debug( json.dumps(subcollection,  indent=4, sort_keys=True) )

            self.assertEqual(subcollection["test_id"] , obj["id"])
    """
